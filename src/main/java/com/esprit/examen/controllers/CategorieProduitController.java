...
public class CategorieProduitController {
	...
	@ResponseBody
	public CategorieProduit addCategorieProduit(@RequestBody CategorieProduitDto cpd) {
		CategorieProduit  cp = new CategorieProduit(cpd);
	...
	@ResponseBody
	public CategorieProduit modifyCategorieProduit(@RequestBody CategorieProduitDto cpdto) {
		CategorieProduit  cp = new CategorieProduit(cpdto);
